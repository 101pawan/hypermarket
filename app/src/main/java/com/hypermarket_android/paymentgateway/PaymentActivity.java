package com.hypermarket_android.paymentgateway;
...
public class PaymentActivity extends AppCompatActivity implements View.OnClickListener,CustomModel.OnCustomStateListener/*, responseinterface*/ {
...
//    ExpandableLayout exp_merchant_details, exp_billing_address, exp_shipping_address, exp_standard_instructions;
    ...
    public void onClick(View v) {
        ...
        if(id==R.id.sdk)
        {
            ...
            m.setAccess_code(ed_access_code.getText().toString().trim());
            m.setMerchant_id(ed_merchant_id.getText().toString().trim());
            m.setCurrency(ed_currency.getText().toString().trim());
            m.setAmount(ed_amount.getText().toString().trim());
            m.setRedirect_url(ed_redirect_url.getText().toString().trim());
            m.setCancel_url(ed_cancel_url.getText().toString().trim());
            m.setRsa_url(ed_rsa_url.getText().toString().trim());
            m.setOrder_id(ed_order_id.getText().toString().trim());
            m.setCustomer_id(ed_customer_id.getText().toString().trim());
            m.setPromo_code(ed_promo_code.getText().toString().trim());
            m.setAdd1(ed_add1.getText().toString().trim());
            m.setAdd2(ed_add2.getText().toString().trim());
            m.setAdd3(ed_add3.getText().toString().trim());
            m.setAdd4(ed_add4.getText().toString().trim());
            m.setAdd5(ed_add5.getText().toString().trim());

//            m.setAccess_code("AVQN03IK92BL47NQLB");
//            m.setMerchant_id("45990");
//            m.setCurrency("AED");
//            m.setAmount("1.00");
//            m.setRedirect_url("https://yasmart.azurewebsites.net/ccavResponseHandler");
//            m.setCancel_url("https://yasmart.azurewebsites.net/ccavResponseHandler");
//            m.setRsa_url("https://yasmart.azurewebsites.net/getrsa");
//            m.setOrder_id("3161386");
//            m.setCustomer_id("oli");
//            m.setPromo_code("");
//            m.setAdd1("test1");
//            m.setAdd2("test1");
//            m.setAdd3("test1");
...
//            m.setAdd5("test1");
            ...
            Log.e("ed_access_code",ed_access_code.getText().toString().trim());
            Log.e("ed_merchant_id",ed_merchant_id.getText().toString().trim());
            Log.e("ed_currency",ed_currency.getText().toString().trim());
            Log.e("ed_amount",ed_amount.getText().toString().trim());
            Log.e("ed_redirect_url",ed_redirect_url.getText().toString().trim());
            Log.e("ed_cancel_url",ed_cancel_url.getText().toString().trim());
            Log.e("ed_rsa_url",ed_rsa_url.getText().toString().trim());
            Log.e("ed_order_id",ed_order_id.getText().toString().trim());
            Log.e("ed_customer_id",ed_customer_id.getText().toString().trim());
            Log.e("ed_promo_code",ed_promo_code.getText().toString().trim());
            Log.e("ed_add1",ed_add1.getText().toString().trim());
            Log.e("ed_add2",ed_add2.getText().toString().trim());
            Log.e("ed_add3",ed_add3.getText().toString().trim());
            Log.e("ed_add4",ed_add4.getText().toString().trim());
            Log.e("ed_add5",ed_add5.getText().toString().trim());
...
//            b.setState("Charli");
//            b.setCity("Charli");
//            b.setTelephone("Charli");
//            b.setEmail("Charli");

            Log.e("ed_name_b",ed_name_b.getText().toString().trim());
            Log.e("ed_address_b",ed_address_b.getText().toString().trim());
            Log.e("ed_country_b",ed_country_b.getText().toString().trim());
            Log.e("ed_state_b",ed_state_b.getText().toString().trim());
            Log.e("ed_city_b",ed_city_b.getText().toString().trim());
            Log.e("ed_telephone_b",ed_telephone_b.getText().toString().trim());
            Log.e("ed_email_b",ed_email_b.getText().toString().trim());
...
//            s.setCity("Charli");
            ...
            Log.e("ed_name_s",ed_name_s.getText().toString().trim());
            Log.e("ed_address_s",ed_address_s.getText().toString().trim());
            Log.e("ed_city_s",ed_city_s.getText().toString().trim());
            Log.e("ed_country_s",ed_country_s.getText().toString().trim());
            Log.e("ed_state_s",ed_state_s.getText().toString().trim());
            ...
            Log.e("checkboxcheck",chk_ccPromo.isChecked()+" == "+chk_show.isChecked());
            /*// SI data //
