...
class RandomDataRecyclerAdapter (
    private val context: FragmentActivity?,
    private var trendingList: ArrayList<RandomProductDataModel.ProductData>
) :
    RecyclerView.Adapter<RandomDataRecyclerAdapter.MyViewHolder>() {
    ...
    fun getItem(postion:Int): RandomProductDataModel.ProductData{
