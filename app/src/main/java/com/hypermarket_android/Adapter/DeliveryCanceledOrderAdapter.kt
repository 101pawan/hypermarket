...
class DeliveryCanceledOrderAdapter (
    private val context: FragmentActivity?,
    private val listOfOrder: ArrayList<DeliveryOrderListResponse.DeliveryOrderData>
) :
    RecyclerView.Adapter<DeliveryCanceledOrderAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        Log.e("checkpayment",listOfOrder[position].payment_mode.toString())
