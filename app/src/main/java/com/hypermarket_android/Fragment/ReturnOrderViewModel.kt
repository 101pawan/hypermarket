...
import com.hypermarket_android.dataModel.DeliveryOrderStatusUpdateData
...
class ReturnOrderViewModel: BaseViewModel() {
    ...
    fun updateOrder(accessToken: String, orderId: String, statusId: String, reasonId: String, comment: String) {
